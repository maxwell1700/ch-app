...
const Register = () => {
  ...
  return (
    <div>
      <div className="register-container shadow my-5">
        <div className="row justify-content-end">
          <div className="col-md-5 d-flex flex-column align-items-center text-white justify-content-center form-r order-2">
